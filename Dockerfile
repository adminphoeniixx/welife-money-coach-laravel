...
LABEL org.opencontainers.image.title="MoneyCoach"
LABEL org.opencontainers.image.description="Production-ready Dockerfile for the MoneyCoach finance app (Laravel Octane / FrankenPHP)"
...
# System dependencies + PHP extensions needed by MoneyCoach.
RUN apt-get update; \
    apt-get upgrade -yqq; \
